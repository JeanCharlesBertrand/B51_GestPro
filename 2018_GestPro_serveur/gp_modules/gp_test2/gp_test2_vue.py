...
class Vue():
    ...
    def creercadrelogin(self):
        ...
        self.canevalogin=Canvas(self.cadrelogin,width=640,height=480,bg="darkblue")
        self.canevalogin.pack()
        self.orglogin=Entry(bg="blue")
        self.orglogin.insert(0, "CVM")
        self.nomlogin=Entry(bg="blue")
        self.nomlogin.insert(0, "jmd")
        btnconnecter=Button(text="Connecter au serveur",bg="skyblue",command=self.salutations)
